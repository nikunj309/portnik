  ...
  return (
    <div className='h-auto md:h-[46rem] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 bg-[#02081a] '>
      <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-3xl mx-auto'> a passionate Full Stack Developer. With a love for coding and a knack for turning ideas into functional, user-friendly applications, I bring a dynamic blend of creativity and technical expertise to every project. Time to build something remarkable together!</p>
        <div className='mt-6'>
          {/* <Button
